...
public class ngg extends javax.swing.JFrame {
    ...
    public ngg() {
        initComponents();
        compno = (int) (Math.random() * 100 + 1); // Move the random number generation to the constructor
    ...
    private void initComponents() {
        ...
        userno = new javax.swing.JTextArea();
        ...
        jLabel4.setText("Enter the numbers between 1 and  100:");

        userno.setColumns(20);
        userno.setRows(5);
        jScrollPane1.setViewportView(userno);
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/numberguessinggame/Screenshot 2024-01-18 102837.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            guesses++; // Increment the guesses count
            if(un <= 0 || un > 100){
                result.setText("Invalid Guess");
            }
            else if(un == compno){
                result.setText("Your guess is correct..!!You won!!..You got it in "+ guesses +"Tries");    
            }
            else if(un > compno){
    ...
    private javax.swing.JTextArea userno;
